...
public class BinaryTreesYT {
    ...
    public static TreeInfo diameterInfo(Node root) {
        ...
        TreeInfo leftTI = diameterInfo(root.left);
        TreeInfo rightTI = diameterInfo(root.right);
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Diameter of the Tree (with TreeInfo): " + diameterInfo(root).diam);
    }
}
